...
public class AgendaEventos {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2025, Month.APRIL, 2), "Hackathon de Inovação", "Competição de soluções criativas");
        agendaEventos.adicionarEvento(LocalDate.of(2025, 4, 20), "Seminário de Inteligência Artificial", "Discussão sobre IA avançada");
